...
t1 = input('You\'r on a cross road would you like to go "left" or "right""?\n').lower()

if t1 == "left":

    t2 = input("Nou you are on a bank of river would you like to swim or wait?\n").lower()

    if t2 == "wait":

        d1 = input("Ohh Magic door appears would you like to choose red, blue or yellow?\n").lower()
        if d1 == "yellow":
